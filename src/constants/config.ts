const config = {
  ...
  OPENFORMAT_AGENT_KEY: process.env.AGENT_API_KEY,
  OPENFORMAT_AGENT_URL: process.env.AGENT_API_URL,
  DISCORD_BOT_OAUTH: process.env.NEXT_PUBLIC_DISCORD_BOT_OAUTH,
} as const;
