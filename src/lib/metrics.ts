...
export const fetchTotalRewardsMetricsTest = cache(async (
  appId: string, 
  startTime?: string, 
  endTime?: string
): Promise<MetricDataPoint[] | null> => {
  const start = startTime ? parseInt(startTime) / 1000000 : 0;
  const end = endTime ? parseInt(endTime) / 1000000 : Date.now() / 1000;
...
export const fetchUniqueUsersMetricsTest = cache(async (
  appId: string, 
  startTime?: string, 
  endTime?: string
): Promise<MetricDataPoint[] | null> => {
...
export const fetchTotalRewardsMetricsWrapped = cache(async (
  appId: string, 
  startTime?: string, 
  endTime?: string
): Promise<MetricDataPoint[] | null> => {
...
export const fetchUniqueUsersMetricsWrapped = cache(async (
  appId: string, 
  startTime?: string, 
  endTime?: string
): Promise<MetricDataPoint[] | null> => {
